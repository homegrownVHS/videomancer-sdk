...
- Modified test summary to include "23 VHDL unit tests"
...
#### tests/README.md
- Added VHDL test section to test summary (23 tests)
...
- `tests/vhdl/tb_yuv444_to_yuv422.vhd` - yuv444_to_yuv422 testbench (5 tests)
- `tests/vhdl/tb_blanking_yuv444.vhd` - blanking_yuv444 testbench (6 tests)

## Total Test Coverage

- **C++ Unit Tests**: 118 tests across 6 suites ✅
- **VHDL Unit Tests**: 23 tests across 4 suites ✅ NEW
