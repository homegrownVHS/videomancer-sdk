 ...
 *
 * ---------------------------------------------------------------
 * MODIFIED: Stripped to inflate-only subset for Videomancer SDK.
 * Removed compression API (struct uzlib_comp, defl_static.h),
 * checksum API (adler32, crc32), and zlib/gzip header parsers.
 * Only raw DEFLATE decompression is retained.
 * ---------------------------------------------------------------
 */
